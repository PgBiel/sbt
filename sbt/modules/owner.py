...
class Owner(commands.Cog, name="owner"):
    ...
    async def _contact(self, ctx: commands.Context, *, message: str):
        ...
        e.set_footer(text="{0} | {1}".format(ctx.author, format.humanize_datetime()), icon_url=ctx.author.avatar_url)
